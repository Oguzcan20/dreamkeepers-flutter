            ...
            child: Column(
              children: [
                ...
                if (_duplicates.isEmpty)
                  dk_theme.GlassCard(
                    child: Text(
                      l.fusionNoDuplicatesItem(target.name),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(AppLocalizations.of(context).fusionAtMaxStars(target.name), style: const TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w600)),
        ],
      ),
    );
  }
